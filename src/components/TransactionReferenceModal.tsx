...
export default function TransactionReferenceModal({
  ...
  const [step, setStep] = useState<"instructions" | "reference" | "success">(
    "instructions"
  );
          ...
          <div className="p-6 mt-16">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-blue-800 text-sm">
                    Make a bank transfer to the account below, then provide your
                    transaction reference for instant verification.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={() =>
                        handleCopyToClipboard(orderData.bankDetails.accountName)
                      }
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium">
                    {orderData.bankDetails.bankName}
                  </span>
                </div>
                ...
                <div className="flex justify-between items-center border-t pt-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={() =>
                        handleCopyToClipboard(orderData.amount.toString())
                      }
                      className="text-blue-600 hover:text-blue-800"
                    >
                      <Icon icon="mdi:content-copy" width={16} height={16} />
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
              ...
              <ul className="text-yellow-800 text-sm space-y-1">
                <li>
                  • Transfer the EXACT amount: {formatPrice(orderData.amount)}
                </li>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-green-800 text-sm">
                    Great! Now enter your transaction reference number for
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setTransactionReference(e.target.value.toUpperCase())
                  }
              ...
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">
                  Expected: {formatPrice(orderData.amount)} (small differences
                  for bank charges are acceptable)
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <h4 className="font-medium text-gray-900 mb-2">
                  Where to find your transaction reference:
                </h4>
                <ul className="text-gray-700 text-sm space-y-1">
                  <li>
                    • <strong>SMS:</strong> Check the transaction SMS from your
                    bank
                  </li>
                  <li>
                    • <strong>Mobile App:</strong> View transaction details in
                    your banking app
                  </li>
                  <li>
                    • <strong>Receipt:</strong> Check your transfer
                    receipt/confirmation
                  </li>
                  <li>
                    • <strong>Bank Statement:</strong> Reference appears on your
                    statement
                  </li>
                </ul>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-2 justify-between">
                ...
                <button
                  ...
                  className="bg-green-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-green-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex justify-center items-center gap-2 text-center"
                >
                  {loading ? (
                    <>
            ...
            {verificationResult.verified ? (
              ...
              <div className="text-center">
                  ...
                  <div className="text-left space-y-2">
                    ...
                    <p>
                      ...
                      <code className="bg-gray-100 px-2 py-1 rounded">
                        {verificationResult.data.transactionReference}
                      </code>
                    </p>
                    <p>
                ...
                <p className="text-sm text-gray-600 mb-6">
                  You'll receive an order confirmation email shortly. We'll
                  begin processing your order immediately.
                </p>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
                  <div className="text-left space-y-2">
                    ...
                    <p>
                      ...
                      {verificationResult.data.estimatedVerificationTime}
                    </p>
                  </div>
                </div>

                <p className="text-sm text-gray-600 mb-6">
                  We'll send you an email confirmation once your payment is
                  verified. Please keep this page open or save your order ID for
                  reference.
                </p>
